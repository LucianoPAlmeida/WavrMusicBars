...
open class BarsView: UIView {
    ...
    private func resizeBars() {
        leftBar.frame = CGRect(x: self.frame.size.width * 0.1, y: 0.0, width: self.frame.size.width * 0.2, height: 0.0)
        middleBar.frame = CGRect(x: self.frame.size.width * 0.4, y: 0.0, width: self.frame.size.width * 0.2, height: 0.0)
        rightBar.frame = CGRect(x: self.frame.size.width * 0.7, y: 0.0, width: self.frame.size.width * 0.2, height: 0.0)
    }
